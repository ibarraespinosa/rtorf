...
![GitHub commit activity](https://img.shields.io/github/commit-activity/y/atmoschem/rtorf)
...
![GitHub Repo stars](https://img.shields.io/github/stars/atmoschem/rtorf)
...
e.g. for the `aircraft-pfp` we can read $CO_2$ and $CH_4$ [here](https://atmoschem.github.io/rtorf/articles/aircraft-pfp.html)

## Implementation in python:

I'm currently implementing a version in python [pytorf](https://github.com/atmoschem/pytorf):
...
<p>
  <a href="https://github.com/atmoschem/rtorf/stargazers">
    <img src="http://reporoster.com/stars/dark/atmoschem/rtorf"/>
  </a>
</p>
